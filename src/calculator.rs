use refx_pp::{
    osu::{OsuDifficultyAttributes, OsuPerformanceAttributes}, relax::OsuPP, osu_2019_scorev2::FxPP, AnyPP, AnyStars, DifficultyAttributes, GameMode, Mods, PerformanceAttributes
};
use pyo3::{
...
impl PyCalculator {
    ...
    fn performance(&self, map: &PyBeatmap) -> PyResult<PyPerformanceAttributes> {
        // * if a player is playing on scorev2, we give them the future pp calculation
